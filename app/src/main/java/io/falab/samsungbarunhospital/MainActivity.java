                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if ("1872".equals(input.getText().toString())) {
                                        Toast.makeText(getApplicationContext(), "관리자 진입", Toast.LENGTH_SHORT).show();
                                        startNewActivity(MainActivity.this, "com.simplemobiletools.applauncher");
                                    } else {
